...
PSQL := docker exec postgres-market psql -U $(DB_USER) -d $(DB_NAME)
...
gen:
	...
	oapi-codegen -config openapi/.openapi -include-tags warehouse -package warehouse openapi/openapi.yaml > ./internal/web/warehouse/api.gen.go
